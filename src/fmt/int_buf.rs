...
//!
//
// Forked from [itoa](https://crates.io/crates/itoa/1.0.6).
//
// # MAJOR CHANGES
...
impl IntBuf {
    ...
    ///
    /// ```
    /// assert_eq!("1234", textos::fmt::IntBuf::new().to_str(1234));
    /// ```
    ...
    /// Print an integer into this buffer and return a reference to its byte
    /// buffer within the buffer.
    ///
    /// # Example
    ///
    /// ```
    /// assert_eq!(&[49, 50, 51, 52], textos::fmt::IntBuf::new().to_bytes(1234));
    /// ```
